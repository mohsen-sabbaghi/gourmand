package com.example.gourmand.aspects;
...
public class LoggableAspect {
    ...
    public Object trace(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        Map<String, String> mapRequest = getHeadersInfo(httpServletRequest);
        ...
        log.debug("[" + String.format("%-6d", (System.currentTimeMillis() - startTime)) + " ms] " +
                String.format("%-50s", classMethod) + " -> IP: " + clientIp + " ;#" + rest + " ;#result:"
                + result + " ;#headers.request: " + mapRequest + " ;#header.response: " + mapResponse);
